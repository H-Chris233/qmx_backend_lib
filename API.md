...
**⚠️ 注意：** v2.5.0包含重要的破坏性API变更，请查看 **[📋 变更说明文档](API_CHANGES_v2.5.0.md)** 了解详情。

**主要变更：**
- `Student.age` 字段从 `u8` 更改为 `Option<u8>`，支持年龄字段为空
- `StudentBuilder::new()` 和 `StudentUpdater::age()` 方法参数类型变更
- `Student::set_age()` 和 `Student::age()` 方法签名变更
